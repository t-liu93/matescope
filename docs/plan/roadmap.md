...
| --- | --- | --- |
| [M0](milestones/M0.md) | Local Compose preview, web onboarding, read-only data, backup/restore, CI and dual-platform release, VPS acceptance | T01 scaffold implemented; T02–T09 pending |
