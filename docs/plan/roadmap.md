...
| [M1](milestones/M1.md) | Concise overview, complete-history date picker, trip/charge summaries and charts, responsive navigation; reuse existing PWA foundations | Complete: all 36 bounded steps (T01–T36) passed implementation, independent review, and integration checks, with one commit per step. The owner reported a brief local walkthrough with no issues and confirmed M1 handoff; this does not assert that every planned manual scenario or real-data compatibility check was individually performed. PostgreSQL-only data in M1; continuous MQTT and advanced analysis excluded. `v0.1.0-alpha.3` is published after passing the tag checks, native amd64/arm64 image validation, and anonymous pull; production deployment and real-data compatibility validation remain pending. |
...
Release baseline: [`v0.1.0-alpha.3`](https://github.com/t-liu93/matescope/releases/tag/v0.1.0-alpha.3), image `ghcr.io/t-liu93/matescope:0.1.0-alpha.3`, manifest `sha256:46d92de26e4eb9e645bc8d59c1659a7d349e95f156c59a4e125df4e8f0a464bc`, source `102a63d9fef137787b8c6da87a0882429cbbecc0`. Release publication does not establish that this version has been deployed on the VPS.
