...
| [M1](milestones/M1.md) | Concise overview, complete-history date picker, trip/charge summaries and charts, responsive navigation; reuse existing PWA foundations | Orchestrated implementation authorized for all 36 bounded steps: T01–T21 passed implementation, independent review, and integration checks; T22–T36 not started. PostgreSQL-only data in M1; continuous MQTT and advanced analysis excluded. Human acceptance, publication, and deployment remain pending. |
